...
public class ReplyController {
    ...
    public ReplyResponse retrieveReply(@PathVariable("letterId") String letterId) {
    ...
    @ResponseStatus(HttpStatus.OK)
    public List<ReplyResponse> getTopNLetters(
    ...
    @ResponseStatus(HttpStatus.OK)
    public Page<ReplyResponse> findMyLetters(
